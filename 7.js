...
//я правильно понимаю последовательность действий пользователя:
1) нажимает красную кнопку
2) открывается календарь, где он должен указать дату рождения
3) выбирает дату, мы ее присваиваем переменной и даем класс .birthday
4) календарь закрывается после выбора даты рождения. // 